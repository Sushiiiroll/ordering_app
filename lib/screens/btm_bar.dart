...
import 'package:ordering_app/screens/categories.dart';
import 'package:ordering_app/screens/home_screen.dart';
import 'package:ordering_app/screens/reservation.dart';
import 'package:ordering_app/screens/user.dart';
...
class _BottomBarScreenState extends State<BottomBarScreen> {
  ...
  {'page' : const ReservationScreen(), 'title': 'Cart Screen'},
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            icon: Icon(_selectedIndex == 3 ? IconlyBold.calendar : IconlyLight.calendar),
            label: "Reservation",
          ),
          BottomNavigationBarItem(
